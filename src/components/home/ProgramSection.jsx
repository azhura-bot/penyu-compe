...
function ProgramCard({ title, position }) {
  return (
    <article
      className="group relative w-full max-w-[17rem] cursor-pointer overflow-hidden rounded-[0.2rem] shadow-[0_16px_32px_rgba(0,0,0,0.22)] transition duration-300 hover:-translate-y-2 hover:shadow-[0_24px_44px_rgba(0,0,0,0.34)] sm:max-w-[18rem] lg:max-w-[19rem]"
    >
      <div
    ...
    <section id="program" className="relative isolate flex min-h-screen items-center overflow-visible py-20 sm:py-24 lg:py-28">
      ...
      <div className="relative z-20 mx-auto w-full max-w-[92rem] px-6 sm:px-8 lg:px-12 xl:px-16">
        <div className="w-full">
          ...
          <p className="mt-5 w-full max-w-none text-sm leading-7 text-white/90 text-shadow-[0_4px_24px_rgba(0,0,0,0.75)] sm:text-base lg:text-lg">
